...
public interface DBCollection {
    ...
    DBDocument create(String id, RequestListener listener);
    ...
    DBDocument create(RequestListener listener);
    ...
    List<? extends DBDocument> search(QueryFilter filter, RequestListener listener);
